...
import uno.meng.ner.utility.MathTools;
...
public class Vertex {
  ...
  public boolean confirmNature(Nature nature, boolean updateWord) {
    switch (nature) {
      ...
      case t:
        ...
        break;
      default:
        System.out.println("没有与" + nature + "对应的case");
        break;
    }
  ...
  public static Vertex newPlaceInstance(String realWord, int frequency) {
    return new Vertex(Predefine.TAG_PLACE, realWord,
  ...
  public static Vertex newOrganizationInstance(String realWord, int frequency) {
    return new Vertex(Predefine.TAG_GROUP, realWord,
  ...
  public static Vertex newB() {
    return new Vertex(Predefine.TAG_BIGIN, " ",
        new CoreDictionary.Attribute(Nature.begin, uno.meng.Constants.MAX_FREQUENCY / 10),
  ...
  public static Vertex newE() {
    return new Vertex(Predefine.TAG_END, " ",
        new CoreDictionary.Attribute(Nature.end, uno.meng.Constants.MAX_FREQUENCY / 10),
