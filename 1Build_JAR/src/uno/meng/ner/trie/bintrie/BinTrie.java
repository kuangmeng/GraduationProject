 ...
 *
 * <copyright file="BinTrie.java" company="上海林原信息科技有限公司"> Copyright (c) 2003-2014, 上海林原信息科技有限公司. All
...
import uno.meng.ner.trie.ITrie;
import java.io.*;
import java.util.*;
...
public class BinTrie<V> extends BaseNode<V> implements ITrie<V>, Externalizable {
  ...
  public boolean save(String path) {
    try {
      ...
      System.out.println("保存到" + path + "失败" + TextUtility.exceptionToString(e));
      return false;
    }
  ...
  public boolean save(DataOutputStream out) {
    try {
      ...
      System.out.println("保存到" + out + "失败" + TextUtility.exceptionToString(e));
      return false;
    }
