package uno.meng.ner.domain;

import uno.meng.crf_seg.util.MathUtil;
...
public class Term implements Serializable {
  ...
  // 词性列表
  private SegItem item = SegItem.NULL;
  // 同一行内数据
  private Term next;
  // 分数
  ...
  public Term(String name, int offe, SegItem item) {
    super();
    this.name = name;
    this.offe = offe;
    this.item = item;
  ...
  public Term(String name, int offe) {
    this.realName = name;
    this.offe = offe;
  }
