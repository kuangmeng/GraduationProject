...
public class CoreBiGramTableDictionary {
  ...
  static {
    String path = uno.meng.Constants.BiGramDictionaryPath;
  ...
  static boolean load(String path) {
    String datPath = uno.meng.Constants.BiGramDictionaryPath + ".table" + ".bin";
    if (loadDat(datPath))
      return true;
    BufferedReader br;
  ...
  public static boolean reload() {
    String biGramDictionaryPath = uno.meng.Constants.BiGramDictionaryPath;
