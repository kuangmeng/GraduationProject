...
public class PropertiesArgs {
  /**
   * Parse properties instead of String arguments. Any additional arguments need to be passed some
   * other way. This is often used in a second pass when the property filename is passed on the
   * command line. Because of required properties you must be careful to set them all in the
   * property file.
   *
