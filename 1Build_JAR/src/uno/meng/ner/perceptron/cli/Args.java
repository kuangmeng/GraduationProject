...
package uno.meng.ner.perceptron.cli;
...
public class Args {
  ...
  public static List<String> parse(Object target, String[] args, boolean failOnExtraFlags) {
    ...
    for (Class<?> currentClazz = clazz; currentClazz != null; currentClazz =
  ...
  private static void addArgument(Class type, Field field, Object target, Object value,
      String delimiter) {
    try {
  ...
  private static void addPropertyArgument(Class type, PropertyDescriptor property, Object target,
  ...
  private static void processProperty(Object target, PropertyDescriptor property,
  ...
  private static void propertyUsage(PrintStream errStream, Object target,
  ...
  private static void propertyUsage(PrintStream errStream, String prefix, String name, String alias,
      Class<?> type, String delimiter, String description, Object defaultValue) {
  ...
  private static Object consumeArgumentValue(String name, Class<?> type, Argument argument,
      Iterator<String> i) {
    Object value;
    if (type == Boolean.TYPE || type == Boolean.class) {
      value = true;
  ...
  static void setProperty(Class<?> type, PropertyDescriptor property, Object target, Object value,
      String delimiter) {
    try {
  ...
  /**
   * Creates a {@link ValueCreator} object able to create object assignable from given type, using a
   * static one arg method which name is the the given one taking a String object as parameter
   *
   * @param compatibleType the base assignable for which this object will try to invoke the given
   *        method
   * @param methodName the name of the one arg method taking a String as parameter that will be used
   *        to built a new value
   * @return null if the object could not be created, the value otherwise
   */
  public static ValueCreator byStaticMethodInvocation(final Class<?> compatibleType,
  ...
  /**
   * {@link ValueCreator} building object using a one arg constructor taking a {@link String} object
   * as parameter
   */
  ...
  private static List<ValueCreator> valueCreators =
      new ArrayList<ValueCreator>(DEFAULT_VALUE_CREATORS);
